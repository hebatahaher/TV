...
<div>
<h3 class="text-center"> شكرا لك على زيارة موقعنا أتمنى أن نلقاك قريبا   </h3>
</div>
<form style="background-color:#0077b3;margin-bottom:150px;margin-right:300px;margin-left:300px;padding:50x;"class="form" action="" method="post" enctype="multipart/form-data" autocomplete="off">
...
<input type="password" class="form-control" name="password" placeholder="password">
	  ...
	  <br>
	  <P class="text-center">Not a member yet ? <a href="index.php" style="color:black;">Sign Up </a></P>
    </form>
  </div>
</div></form>
